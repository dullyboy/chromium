...
class WebViewDelegateFactory {
     ...
     */
    static WebViewDelegate createProxyDelegate(tv.webkit.WebViewDelegate delegate) {
        Log.d("WebViewDelegateFactory", "liubin add createProxyDelegate");
    ...
    static WebViewDelegate createApi21CompatibilityDelegate() {
        Log.d("WebViewDelegateFactory", "liubin add createApi21CompatibilityDelegate");
    ...
    private static class ProxyDelegate implements WebViewDelegate {
        ...
        tv.webkit.WebViewDelegate delegate;

        ProxyDelegate(tv.webkit.WebViewDelegate delegate) {
        ...
        public void setOnTraceEnabledChangeListener(final OnTraceEnabledChangeListener listener) {
            delegate.setOnTraceEnabledChangeListener(
                    new tv.webkit.WebViewDelegate.OnTraceEnabledChangeListener() {
                        @Override
