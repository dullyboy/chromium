...
import tv.webkit.CookieManager;
import tv.webkit.GeolocationPermissions;
import tv.webkit.WebIconDatabase;
import tv.webkit.WebStorage;
import tv.webkit.WebView;
import tv.webkit.WebViewDatabase;
import tv.webkit.WebViewFactory;
import tv.webkit.WebViewFactoryProvider;
import tv.webkit.WebViewProvider;
...
import com.android.org.chromium.android_webview.AwContentsStatics;
...
import com.android.org.chromium.base.CommandLine;
import com.android.org.chromium.base.MemoryPressureListener;
import com.android.org.chromium.base.PathService;
import com.android.org.chromium.base.PathUtils;
import com.android.org.chromium.base.ResourceExtractor;
import com.android.org.chromium.base.ThreadUtils;
import com.android.org.chromium.base.TraceEvent;
import com.android.org.chromium.base.library_loader.LibraryLoader;
import com.android.org.chromium.base.library_loader.ProcessInitException;
...
public class WebViewChromiumFactoryProvider implements WebViewFactoryProvider {
     ...
     */
    public WebViewChromiumFactoryProvider(tv.webkit.WebViewDelegate delegate) {
        Log.d("WCFP:", "123");
...
//                    Log.w(TAG, "Failed to delete " + file);
    ...
    private void ensureChromiumStartedLocked(boolean onMainThread) {
        ...
        Log.v("liubin WCFP", "Binding Chromium to " +
    ...
    private void setUpResources(Context context) {
        ...
        ResourceRewriter.rewriteRValues(
                mWebViewDelegate.getPackageId(context.getResources(), "com.tvbrowser0728"));
        AwResource.setResources(context.getResources());
        AwResource.setErrorPageResources(0x01100000,0x01100001);
        AwResource.setConfigKeySystemUuidMapping(0x01070005);
