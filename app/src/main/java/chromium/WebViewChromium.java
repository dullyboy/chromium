...
import tv.webkit.FindActionModeCallback;
import tv.webkit.JavascriptInterface;
import tv.webkit.WebBackForwardList;
import tv.webkit.WebChromeClient;
import tv.webkit.WebSettings;
import tv.webkit.WebView;
import tv.webkit.WebViewClient;
import tv.webkit.WebViewProvider;
import tv.webkit.WebChromeClient.CustomViewCallback;
...
import com.android.org.chromium.content.browser.SmartClipProvider;
import com.android.org.chromium.content_public.browser.LoadUrlParams;
import com.android.org.chromium.net.NetworkChangeNotifier;
...
//                warningLabel.setText(R.string.err);
                warningLabel.setText(mWebView.getContext().getString(R.string.err));
