 ...
 *             method {@link tv.webkit.CookieManager#flush} which is a synchronous
 *             replacement for {@link #sync}.
 */
@Deprecated
public final class CookieSyncManager extends /*tv.webkit.*/WebSyncManager {
     ...
     * @deprecated Use {@link tv.webkit.CookieManager#flush} instead.
     */
    @Deprecated
    public void sync() {
        /*tv.webkit.*/CookieManager.getInstance().flush();
    }
