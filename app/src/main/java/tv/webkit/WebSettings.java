...
public abstract class WebSettings {
     ...
     * affect zooming performed using the {@link tv.webkit.WebView#zoomIn()} and
     * {@link tv.webkit.WebView#zoomOut()} methods. The default is true.
     *
     ...
     * tag. For pages lacking the tag, {@link tv.webkit.WebView#setInitialScale}
     ...
     * true, {@link tv.webkit.WebChromeClient#onCreateWindow} must be implemented by the
     ...
     * {@link tv.webkit.WebView#reload} is called.
     ...
     *   {@link tv.webkit.WebChromeClient#onGeolocationPermissionsShowPrompt} callback
    ...
    public static String getDefaultUserAgent(Context context) {
        return /*tv.webkit.*/WebViewFactory.getProvider().getStatics().getDefaultUserAgent(context);
    }

    /**
     * Tells the WebView whether it needs to set a node to have focus when
     * {@link tv.webkit.WebView#requestFocus(int, android.graphics.Rect)} is called. The
