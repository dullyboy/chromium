...
public class WebChromeClient {
     ...
     */
    public void onProgressChanged(/*tv.webkit.*/WebView view, int newProgress) {}
     ...
     */
    public void onReceivedTitle(/*tv.webkit.*/WebView view, String title) {}
     ...
     */
    public void onReceivedIcon(/*tv.webkit.*/WebView view, Bitmap icon) {}
     ...
     */
    public void onReceivedTouchIconUrl(/*tv.webkit.*/WebView view, String url,
                                       boolean precomposed) {}
     ...
     *                  {@link tv.webkit.WebView.WebViewTransport} object. This should be
     *                  used to transport the new WebView, by calling
     *                  {@link tv.webkit.WebView.WebViewTransport#setWebView(tv.webkit.WebView)
     ...
     *         undefined behavior.
     */
    public boolean onCreateWindow(/*tv.webkit.*/WebView view, boolean isDialog,
     ...
     */
    public void onRequestFocus(/*tv.webkit.*/WebView view) {}
     ...
     */
    public void onCloseWindow(/*tv.webkit.*/WebView window) {}
     ...
     */
    public boolean onJsAlert(/*tv.webkit.*/WebView view, String url, String message,
                             /*tv.webkit.*/JsResult result) {
        return false;
    }
     ...
     */
    public boolean onJsConfirm(/*tv.webkit.*/WebView view, String url, String message,
                               /*tv.webkit.*/JsResult result) {
        return false;
    }
     ...
     */
    public boolean onJsPrompt(/*tv.webkit.*/WebView view, String url, String message,
     ...
     * @return boolean Whether the client will handle the confirm dialog.
     */
    public boolean onJsBeforeUnload(/*tv.webkit.*/WebView view, String url, String message,
                                    /*tv.webkit.*/JsResult result) {
        return false;
    }
    ...
    * {@link tv.webkit.WebStorage.QuotaUpdater#updateQuota(long) updateQuota(long)}
    * method of the supplied {@link tv.webkit.WebStorage.QuotaUpdater} instance. The
    ...
    * @param quotaUpdater An instance of {@link tv.webkit.WebStorage.QuotaUpdater} which
    ...
    */
    ...
    public void onExceededDatabaseQuota(String url, String databaseIdentifier,
            ...
            /*tv.webkit.*/WebStorage.QuotaUpdater quotaUpdater) {
    ...
    */
     ...
     * {@link tv.webkit.GeolocationPermissions} for details.
     ...
     * {@link #onGeolocationPermissionsShowPrompt(String, tv.webkit.GeolocationPermissions.Callback) onGeolocationPermissionsShowPrompt()}
     ...
     * or denied. The host application must invoke {@link tv.webkit.PermissionRequest#grant(String[])}
     * or {@link tv.webkit.PermissionRequest#deny()}.
     *
     * If this method isn't overridden, the permission is denied.
     *
     * @param request the PermissionRequest from current web content.
     */
    public void onPermissionRequest(/*tv.webkit.*/PermissionRequest request) {
        request.deny();
    }
     ...
     */
    public void onPermissionRequestCanceled(/*tv.webkit.*/PermissionRequest request) {}
     ...
     * @deprecated Use {@link #onConsoleMessage(tv.webkit.ConsoleMessage) onConsoleMessage(ConsoleMessage)}
     *      instead.
     */
    @Deprecated
     ...
     */
    public boolean onConsoleMessage(/*tv.webkit.*/ConsoleMessage consoleMessage) {
     ...
     */
    public void getVisitedHistory(/*tv.webkit.*/ValueCallback<String[]> callback) {
    }
     ...
     */
    public boolean onShowFileChooser(/*tv.webkit.*/WebView webView, /*tv.webkit.*/ValueCallback<Uri[]> filePathCallback,
    ...
    public static abstract class FileChooserParams {
        ...
        public static Uri[] parseResult(int resultCode, Intent data) {
            return /*tv.webkit.*/WebViewFactory.getProvider().getStatics().parseFileChooserResult(resultCode, data);
        }
    ...
    @SystemApi
    @Deprecated
    public void openFileChooser(/*tv.webkit.*/ValueCallback<Uri> uploadFile, String acceptType, String capture) {
