...
public class GeolocationPermissions {
     ...
     * called before the application instantiates a {@link tv.webkit.WebView} instance.
     *
     * @return the singleton {@link GeolocationPermissions} instance
     */
    public static GeolocationPermissions getInstance() {
      return /*tv.webkit.*/WebViewFactory.getProvider().getGeolocationPermissions();
    }

    /**
     * Gets the set of origins for which Geolocation permissions are stored.
     *
     * @param callback a {@link tv.webkit.ValueCallback} to receive the result of this
     *                 request. This object's
     *                 {@link tv.webkit.ValueCallback#onReceiveValue(T) onReceiveValue()}
    ...
    // on this string.
    public void getOrigins(android.webkit.ValueCallback<Set<String> > callback) {
     ...
     *                 Geolocation API.
     */
    public void getAllowed(String origin, /*.webkit.*/ValueCallback<Boolean> callback) {
        // Must be a no-op for backward compatibility: see the hidden constructor for reason.
    }
