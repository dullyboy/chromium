...
public class WebStorage {
     ...
     * See
     * {@link tv.webkit.WebChromeClient#onExceededDatabaseQuota} and
     * {@link tv.webkit.WebChromeClient#onReachedMaxAppCacheSize}.
     ...
     * being provided via a {@link tv.webkit.ValueCallback}. The origins are provided as
     ...
     * a {@link tv.webkit.ValueCallback}.
     */
    public void getUsageForOrigin(String origin, /*tv.webkit.*/ValueCallback<Long> callback) {
        // Must be a no-op for backward compatibility: see the hidden constructor for reason.
    }
     ...
     * being provided via a {@link tv.webkit.ValueCallback}. Note that a quota is not
     * enforced on a per-origin basis for the Application Cache API.
     */
    public void getQuotaForOrigin(String origin, /*tv.webkit.*/ValueCallback<Long> callback) {
        // Must be a no-op for backward compatibility: see the hidden constructor for reason.
    }
    ...
    public static WebStorage getInstance() {
      return /*tv.webkit.*/WebViewFactory.getProvider().getWebStorage();
    }
