...
import tv.webkit.CacheManager.CacheResult;
import tv.webkit.PluginData;
import tv.webkit.UrlInterceptHandler;
...
public final class UrlInterceptRegistry {
    ...
    private static synchronized LinkedList getHandlers() {
        if(mHandlerList == null)
            mHandlerList = new LinkedList</*tv.webkit.*/UrlInterceptHandler>();
        return mHandlerList;
    }
    ...
    public static synchronized boolean registerHandler(
            /*tv.webkit.*/UrlInterceptHandler handler) {
    ...
    public static synchronized CacheResult getSurrogate(
        ...
        while (iter.hasNext()) {
            /*tv.webkit.*/UrlInterceptHandler handler = (/*tv.webkit.*/UrlInterceptHandler) iter.next();
