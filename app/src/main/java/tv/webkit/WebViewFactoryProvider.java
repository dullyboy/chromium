...
public interface WebViewFactoryProvider {
    ...
    interface Statics {
         ...
         * {@link tv.webkit.WebView#findAddress(String)}
         */
        ...
        /**
         * Implements the API method:
         * {@link tv.webkit.WebView#setWebContentsDebuggingEnabled(boolean) }
         */
        void setWebContentsDebuggingEnabled(boolean enable);

        /**
         * Implements the API method:
         * {@link tv.webkit.WebView#clearClientCertPreferences(Runnable) }
         */
        void clearClientCertPreferences(Runnable onCleared);

        /**
         * Implements the API method:
         * {@link tv.webkit.WebView#setSlowWholeDocumentDrawEnabled(boolean) }
         */
        void enableSlowWholeDocumentDraw();

        /**
         * Implement the API method
         * {@link tv.webkit.WebChromeClient.FileChooserParams#parseResult(int, Intent)}
         */
     ...
     */
    WebViewProvider createWebView(/*tv.webkit.*/WebView webView, /*tv.webkit.*/WebView.PrivateAccess privateAccess);
     ...
     */
    /*tv.webkit.*/GeolocationPermissions getGeolocationPermissions();
     ...
     */
    /*tv.webkit.*/CookieManager getCookieManager();
     ...
     */
    /*tv.webkit.*/WebIconDatabase getWebIconDatabase();
     ...
     */
    /*tv.webkit.*/WebStorage getWebStorage();
     ...
     */
    /*tv.webkit.*/WebViewDatabase getWebViewDatabase(Context context);
}
