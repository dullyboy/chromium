...
import tv.app.ActivityManagerInternal;
...
import tv.helper.LocalServices;
...
public final class WebViewFactory {
    ...
    private static final String CHROMIUM_WEBVIEW_FACTORY =
            "chromium.WebViewChromiumFactoryProvider";
...
//                Trace.traceBegin(Trace.TRACE_TAG_WEBVIEW, "WebViewFactory.loadNativeLibrary()");
                Log.d(LOGTAG, "getProvider: liubin add loadNativeLibrary001");
                loadNativeLibrary();
...
//                    String[] files = null;
//                    try {
//                        files = initialApplication.getAssets().list("");
//                    } catch (IOException e) {
//                        e.printStackTrace();
//                    }
...
//                    }
                    Log.d(LOGTAG, "getProvider:liubin providerClass");
//                    providerClass = (Class<WebViewFactoryProvider>)Class.forName("chromium.WebViewChromiumFactoryProvider");
                    Log.d(LOGTAG, "getProvider: providerClass = " + providerClass);
...
//                Trace.traceBegin(Trace.TRACE_TAG_WEBVIEW, "providerClass.newInstance()");
                try {
                    try {
                        ...
                        Log.d(LOGTAG, "liubin sProviderInstance001");
                        Constructor strCtor = providerClass.getConstructor(tv.webkit.WebViewDelegate.class);
                        Log.d(LOGTAG, "getProvider: strCtor = " + strCtor.toString());

                        sProviderInstance = providerClass.getConstructor(tv.webkit.WebViewDelegate.class)
                                .newInstance(new tv.webkit.WebViewDelegate());
                    } catch (Exception e) {
                        Log.d(LOGTAG, "liubin sProviderInstance002");
                        Constructor strCtor1 = providerClass.getConstructor(tv.webkit.WebViewDelegate.class);
                        Log.d(LOGTAG, "getProvider: strCtor1 = " + strCtor1.toString());

                        sProviderInstance = providerClass.newInstance();//赋值是在这里进行的，为了兼容以前版本和开发人员自己写的控件
                    }
...
//                Trace.traceEnd(Trace.TRACE_TAG_WEBVIEW);
    ...
    private static Class<WebViewFactoryProvider> getFactoryClass() throws ClassNotFoundException {
        Log.d(LOGTAG, "liubin add getFactoryClass");
        Application initialApplication = AppGlobals.getInitialApplication();
        try {
...
//            Trace.traceBegin(Trace.TRACE_TAG_WEBVIEW, "Class.forName()");
            try {
                return (Class<WebViewFactoryProvider>) Class.forName("chromium.WebViewChromiumFactoryProvider"/*CHROMIUM_WEBVIEW_FACTORY*/, true,
                        clazzLoader);
            } finally {
                Log.d(LOGTAG, "getFactoryClass");
//                Trace.traceEnd(Trace.TRACE_TAG_WEBVIEW);
            }
...
//            // original exception.
    ...
    public static void prepareWebViewInZygote() {
        try {
            ...
            Log.d(LOGTAG, "prepareWebViewInZygote addressSpaceToReserve = " + addressSpaceToReserve);
            sAddressSpaceReserved = nativeReserveAddressSpace(addressSpaceToReserve);
            Log.d(LOGTAG, "prepareWebViewInZygote sAddressSpaceReserved = " + sAddressSpaceReserved);
...
//        if (!TextUtils.isEmpty(path64)) path64 += "/" + NATIVE_LIB_FILE_NAME;
        return new String[] { path32, null/*liubin addpath64*/ };
    }
...
//                }
        ...
        try {
            ...
            int pid = LocalServices.getService(ActivityManagerInternal.class).startIsolatedProcess(
                    ...
                    /*liubin add Process.*/SHARED_RELRO_UID, crashHandler);
    ...
    private static class RelroFileCreator {
        ...
        public static void main(String[] args) {
            ...
            boolean is64Bit = false;/*liubin add VMRuntime.getRuntime().is64Bit();*/
            try{
...
//                }
    ...
    private static void loadNativeLibrary() {
        Log.d(LOGTAG, "liubin add loadNativeLibrary");
        if (!sAddressSpaceReserved) {
